...
from .symbol_utils import reference_symbol
...
def get_news_yfinance(
    ...
    # returns no news. MCX commodities use their global benchmark's news
    # (GOLD.MCX -> GC=F). Keep the user's ticker in the report header.
    canonical = reference_symbol(ticker)
