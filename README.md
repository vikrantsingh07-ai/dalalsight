...
| Web | `web/` | React 19 + TypeScript + Tailwind 4, TradingView Lightweight Charts, official TradingView Advanced Chart widget, Web Speech API voice |
...
| `TRADINGVIEW_WIDGET_ENABLED` | official embed widget | `true` |
...
* No licensed TradingView Charting Library: the TradingView tab shows TradingView's own data and cannot
  feed the analysis; the engine chart uses the backend provider.
